var TDGame = (function () {
  ...
  var ENEMY_KINDS = {
    ...
    sparkmite: { hpMul: 0.42, speedMul: 1.85, armorAdd: 0, rewardMul: 0.52, r: 8, color: "#facc15", slowResist: 0.1 },
    bogcreep: { hpMul: 1.32, speedMul: 0.62, armorAdd: 0.11, rewardMul: 1.18, r: 12, color: "#166534", slowResist: 0.25 },
    riftling: { hpMul: 0.72, speedMul: 1.42, armorAdd: 0, rewardMul: 0.94, r: 9, color: "#a21caf", slowResist: 0.58 },
    galespawn: { hpMul: 0.55, speedMul: 1.62, armorAdd: 0, rewardMul: 0.78, r: 9, color: "#7dd3fc", slowResist: 0.2 },
    obsidian: { hpMul: 1.68, speedMul: 0.58, armorAdd: 0.24, rewardMul: 1.28, r: 14, color: "#1e293b", slowResist: 0.12 },
    emberwight: { hpMul: 1.12, speedMul: 0.94, armorAdd: 0.05, rewardMul: 1.1, r: 11, color: "#dc2626", slowResist: 0.18 },
    tidewraith: { hpMul: 0.98, speedMul: 1.08, armorAdd: 0.02, rewardMul: 1.06, r: 10, color: "#0369a1", slowResist: 0.4 },
    bonepile: { hpMul: 1.25, speedMul: 0.78, armorAdd: 0.08, rewardMul: 1.14, r: 11, color: "#d6d3d1", slowResist: 0.15, regen: 3.2 },
    flarebat: { hpMul: 0.38, speedMul: 1.88, armorAdd: 0, rewardMul: 0.5, r: 7, color: "#fb7185", slowResist: 0.14 },
    steelhorn: { hpMul: 1.48, speedMul: 0.82, armorAdd: 0.17, rewardMul: 1.2, r: 12, color: "#71717a", slowResist: 0.09 },
  };
  ...
  var ENEMY_UI = {
    ...
    sparkmite: { nameRu: "Искромёт", desc: "Крошечный, молниеносный; слабый, но доставляет помехи." },
    bogcreep: { nameRu: "Топкий ползун", desc: "Тяжёлый болотный тип: много HP, низкая скорость." },
    riftling: { nameRu: "Разломник", desc: "Искажённый бегун: очень устойчив к замедлению." },
    galespawn: { nameRu: "Порождение ветра", desc: "Лёгкий и стремительный; рывками срывается вперёд." },
    obsidian: { nameRu: "Обсидиан", desc: "Плотная «каменная» броня, очень медленный танк." },
    emberwight: { nameRu: "Угольный призрак", desc: "Остатки жара: баланс скорости и живучести." },
    tidewraith: { nameRu: "Приливной дух", desc: "Влажный силуэт: хорошо переносит контроль, но не иммунитет." },
    bonepile: { nameRu: "Костяная куча", desc: "Оживлённые обломки; медленно восстанавливает HP." },
    flarebat: { nameRu: "Пылающая ночница", desc: "Мелкая, очень быстрая цель с низкой наградой." },
    steelhorn: { nameRu: "Стальной рогач", desc: "Тяжёлый пробойник с сильной бронёй." },
  };
